...
4. Paste your script, adjust your padding/font size, and hit **Play**.
    

_Want to host it?_ Drop the `index.html` file into GitHub Pages, Vercel, or Cloudflare Pages, and you have your own production-ready web app in 30 seconds.
